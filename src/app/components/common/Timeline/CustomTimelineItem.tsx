...
const CustomTimeLineItem = (props:IProps) => {
    const { title, timePeriod, isLatest } = props;
    return (
    <div>
        <div className="mb-10 ms-6">            
                ...
                <div className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">
                    {title}
                    { isLatest && (<span className="bg-blue-100 text-blue-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ms-3">Latest</span>)}
                </div>
